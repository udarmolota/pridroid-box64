...
#define BT_BUF_SIZE 100
    ...
    if(sig == X64_SIGSEGV) {
        ...
        // thousands of times — a field report grew this file to 91 MB / 704k lines, with an
        // open/write/close from the signal path on every fault. Log the first 32 hits of a
