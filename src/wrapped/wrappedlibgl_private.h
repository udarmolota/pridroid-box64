...
GOM(glXCreateContext, pFEpppi)             // PriDroid: -> ZFA context (RimWorld 1.6 GLX path)
GOM(glXCreateContextAttribsARB, pFEpppip)  // PriDroid: -> ZFA context
...
GOM(glXChooseVisual, pFEpip)               // PriDroid: -> dummy visual (ZFA path)
GO(glXCopyImageSubDataNV, vFppuuiiiipuuiiiiiii)
GO(glXCopySubBufferMESA, vFpLiiii)
GOM(glXDestroyContext, vFEpp)              // PriDroid: no-op in ZFA path
...
GOM(glXGetClientString, pFEpi)             // PriDroid: sane string (ZFA path; libzfa has no glX)
GOM(glXGetConfig, iFEppip)                 // PriDroid: sane values (ZFA path)
GOM(glXGetCurrentContext, pFEv)            // PriDroid: -> current ZFA handle
GOM(glXGetCurrentDisplay, pFEv)            // PriDroid: -> last display (ZFA path)
GOM(glXGetCurrentDrawable, LFEv)           // PriDroid: -> current drawable (ZFA path)
...
GOM(glXMakeCurrent, iFEpLp)                // PriDroid: -> zfa_make_current / release (ZFA path)
GO(glXQueryContext, iFppip)
GOM(glXQueryDrawable, vFEpLip)             // PriDroid: no-op (ZFA path)
GOM(glXQueryExtension, iFEppp)             // PriDroid: -> True (ZFA path)
GOM(glXQueryExtensionsString, pFEpi)       // PriDroid: -> "" (ZFA path)
...
GOM(glXQueryServerString, pFEpii)          // PriDroid: sane string (ZFA path)
GO(glXQuerySwapGroupNV, iFpLpp)
GOM(glXQueryVersion, iFEppp)               // PriDroid: -> 1.4 (ZFA path)
...
GOM(glXSwapBuffers, vFEpL)                 // PriDroid: -> zfa_swap present (ZFA path)
