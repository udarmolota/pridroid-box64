...
GO2(__connect, iFEipu, my_connect)
GOWM(connect, iFEipu)
...
GOW(dup2, iFii)
GOW(dup3, iFiiO)
GO2(__duplocale, pFEp, my_duplocale)
GOWM(duplocale, pFEp)
GO(dysize, iFi)
GOW(eaccess, iFpi)
#ifdef STATICBUILD
...
GO(freeaddrinfo, vFp)
GOW(freeifaddrs, vFp)
GO2(__freelocale, vFEp, my_freelocale)
GOWM(freelocale, vFEp)
...
//DATAB(getdate_err, 4)
GOW(getdate_r, iFpp)
GO2(__getdelim, lFEppiS, my___getdelim)
GO(getdelim, lFppiS)
GO(getdents64, lFipL)
...
GO(netname2user, iFppppp)
#endif
GO2(__newlocale, pFEipp, my_newlocale)
GOWM(newlocale, pFEipp)
//GO(nfsservctl, 
GOM(nftw, iFEppii)
GOM(nftw64, iFEppii)
GOW(ngettext, pFppL)
...
GOM(sched_getaffinity, iFEiLp)   // PriDroid: custom my_ handler caps mask to BOX64_MAXCPU (see wrappedlibc.c)
GO(sched_getcpu, iFv)
...
GO(updwtmpx, vFpp)
//GO(uselib, 
GO2(__uselocale, pFEp, my_uselocale)
GOWM(uselocale, pFEp)
#ifdef STATICBUILD
//GO(user2netname, 
#else
