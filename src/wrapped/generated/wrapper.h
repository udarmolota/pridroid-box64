...
void pFEu(x64emu_t *emu, uintptr_t fnc);
...
void vFEppu(x64emu_t *emu, uintptr_t fnc);
...
void vFEpLip(x64emu_t *emu, uintptr_t fnc);
...
void lFEipLi(x64emu_t *emu, uintptr_t fnc);
void lFEippL(x64emu_t *emu, uintptr_t fnc);
void lFEuipp(x64emu_t *emu, uintptr_t fnc);
void lFEppiS(x64emu_t *emu, uintptr_t fnc);
...
void vFEpuuuu(x64emu_t *emu, uintptr_t fnc);
...
void iFEpupuU(x64emu_t *emu, uintptr_t fnc);
...
void vFEpuuuiu(x64emu_t *emu, uintptr_t fnc);
...
void pFEpiiiiu(x64emu_t *emu, uintptr_t fnc);
...
void vFEpupuupup(x64emu_t *emu, uintptr_t fnc);
